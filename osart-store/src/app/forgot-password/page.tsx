            ...
            <div className="max-w-[440px] w-full px-5 relative z-10">
                <div className="mb-12 space-y-4 text-center">
                    ...
                    <h1 className="text-4xl sm:text-5xl font-black uppercase italic tracking-tighter text-white">
                        Recuperar <span className="text-sky-500">Acceso</span>
                    </h1>
                ...
                <div className="bg-zinc-900/50 border border-white/5 p-8 relative overflow-hidden group">
                    ...
                    {success ? (
                        <div className="space-y-8 animate-fade">
                            <div className="p-6 bg-sky-500/10 border border-sky-500/20 text-sky-500 text-center space-y-4">
                                <p className="text-[10px] font-black uppercase tracking-[0.2em] leading-relaxed">
                                    Protocolo iniciado. Se ha enviado un enlace de recuperación a su Identificador de Red.
                                </p>
                            </div>
                            <Link href="/login" className="w-full relative py-4 bg-zinc-100 text-black font-black text-[10px] uppercase italic tracking-[0.3em] hover:bg-sky-500 transition-all flex items-center justify-center gap-3">
                                Regresar a Terminal
