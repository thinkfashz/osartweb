        ...
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="flex flex-col lg:flex-row lg:items-center justify-between gap-6 bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
                <div className="space-y-1">
                    ...
                    <h1 className="text-4xl font-black tracking-tighter uppercase italic text-slate-900">Núcleo Base de Datos</h1>
                </div>

                <div className="flex flex-wrap gap-3">
                    <button
                        onClick={handleSync}
                        className="flex items-center gap-2 px-6 py-3 bg-slate-900 text-white rounded-2xl font-bold uppercase italic tracking-widest text-[10px] hover:bg-slate-800 transition-all active:scale-95"
                    >
                    ...
                    <button
                        onClick={handleSeed}
                        disabled={seeding}
                        className="flex items-center gap-2 px-6 py-3 bg-emerald-50 text-emerald-700 border border-emerald-100 rounded-2xl font-bold uppercase italic tracking-widest text-[10px] hover:bg-emerald-100 transition-all disabled:opacity-50"
                    >
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Estado de Enlace</p>
                        <div className="flex items-center gap-2 mt-1">
                            <div className="w-2 h-2 bg-emerald-500 rounded-full animate-pulse" />
                            <h3 className="text-xl font-black uppercase italic tracking-tighter text-slate-900">Operacional</h3>
                        </div>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Entorno</p>
                        <h3 className="text-xl font-black uppercase italic tracking-tighter text-slate-900 mt-1">{status?.databaseUrl || 'Supabase Cloud'}</h3>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Tablas Indexadas</p>
                        <h3 className="text-xl font-black uppercase italic tracking-tighter text-slate-900 mt-1">{tables.length} Entidades</h3>
                    </div>
                </div>
                ...
                <div className="bg-white p-6 rounded-3xl border border-slate-100 shadow-sm space-y-4">
                    ...
                    <div>
                        <p className="text-[10px] font-black uppercase tracking-widest text-slate-400">Versión de Esquema</p>
                        <h3 className="text-xl font-black uppercase italic tracking-tighter text-slate-900 mt-1">v{status?.version || 1}.2.0</h3>
                    </div>
                </div>
            </div>
