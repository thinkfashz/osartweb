        ...
        <header className="h-20 bg-white/80 backdrop-blur-md border-b border-zinc-100 px-4 md:px-8 flex items-center z-40 sticky top-0">
            ...
            <div className="flex items-center gap-4 ml-auto">
                ...
                <div className="flex items-center gap-2 md:gap-3 pl-2 group cursor-pointer">
                    ...
                    <div className="w-10 h-10 rounded-2xl bg-zinc-100 overflow-hidden border-2 border-transparent group-hover:border-zinc-950 transition-all flex items-center justify-center shrink-0">
                        <User size={20} className="text-zinc-400" />
                    </div>
                </div>

                <div className="p-1 pl-2 hidden sm:block">
                    <div className="bg-electric-blue/10 rounded-2xl p-1 pr-3 flex items-center gap-2">
                        <div className="w-8 h-8 rounded-xl bg-electric-blue flex items-center justify-center shadow-lg shadow-electric-blue/20 shrink-0">
                            <Zap size={16} className="text-zinc-950 fill-zinc-950" />
                        </div>
                        <span className="text-[10px] font-black uppercase text-electric-blue-deep leading-none hidden md:block">System<br />Online</span>
                    </div>
                </div>
            </div>
        </header>
