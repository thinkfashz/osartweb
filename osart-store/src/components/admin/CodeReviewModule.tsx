                                ...
                                <div className={cn(
                                    ...
                                    error.type === 'error' ? 'bg-red-500 shadow-[0_0_20px_rgba(239,68,68,0.3)]' :
                                        error.type === 'performance' ? 'bg-amber-500 shadow-[0_0_20px_rgba(245,158,11,0.3)]' :
                                            'bg-violet-500/5 shadow-[0_0_20px_rgba(0,210,255,0.3)]'
                                )} />
                                <div className="p-6 flex-1">
                                    <div className="flex items-center justify-between mb-4">
                                        <div className="flex items-center gap-3">
                                            ...
                                            {error.type === 'connection' && <Cpu size={16} className="text-violet-400" />}
                                    ...
                                    {error.file && (
                                        <div className="flex items-center gap-2 mb-6">
                                            ...
                                            <code className="text-[11px] font-mono text-violet-400 bg-violet-500/5/5 border border-violet-500/10 px-2 py-0.5 rounded">
