    ...
    return (
        <div className="max-w-[1200px] mx-auto px-5 py-24 text-center">
            <div className="relative inline-block mb-10">
                ...
                <div className="absolute -top-4 -right-4 w-12 h-12 bg-electric-blue rounded-lg flex items-center justify-center shadow-lg shadow-electric-blue/20 rotate-12 z-20">
                    <Hammer size={24} className="text-black" />
                </div>
                <div className="absolute inset-0 bg-electric-blue/5 blur-3xl rounded-full scale-150" />
            </div>

            <h1 className="text-4xl sm:text-5xl font-black mb-6 uppercase italic tracking-tighter">
                Inventario <span className="text-electric-blue">Vacio</span>
            </h1>
